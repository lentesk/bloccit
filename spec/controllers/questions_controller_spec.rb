require 'rails_helper'
 ...
 RSpec.describe QuestionsController, type: :controller do
  ...
  describe "PUT update" do
      ...
      put :update, params: { id: my_question.id, question: {title: new_title, body: new_body, resolved: "0" } }
    ...
    it "redirects to the updated question" do
      ...
      new_body = RandomData.random_paragraph
      new_resolved = "0"
      put :update, params: { id: my_question.id, question: {title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: "0" } }
